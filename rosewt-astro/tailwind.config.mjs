  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'aurora-gradient':
          'linear-gradient(135deg, #1ABC9C 0%, #8E44AD 50%, #F1C40F 100%)',
        'cosmic-gradient': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
        'emerald-gradient':
          'linear-gradient(135deg, #10b981 0%, #1ABC9C 50%, #34d399 100%)',
        'aurora-radial':
          'radial-gradient(circle at 50% 50%, #1ABC9C 0%, #8E44AD 50%, #2C3E50 100%)',
        'glass-gradient':
      ...
      keyframes: {
        ...
        glow: {
          ...
          to: {
            'box-shadow':
              '0 0 30px rgba(26, 188, 156, 0.6), 0 0 40px rgba(142, 68, 173, 0.3)',
          },
        },
      },
    },
